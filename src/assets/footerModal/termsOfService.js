const termsOfService = `This ""User Agreement"" (the ""Agreement"") sets forth the terms and conditions governing the use of the Drink Master application (""App"") and its services.
